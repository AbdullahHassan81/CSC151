// Import statements
import java.awt.event.*; // Import the Timer class
import java.io.BufferedReader; // Importing utility classes for event handling
import java.io.InputStreamReader; // Importing utility classes for collections
import java.net.HttpURLConnection; // Importing Swing library for creating GUI components
import java.net.URL;
import java.util.*;
import javax.swing.*;
...
public class AbdullahCurrencyConverter{
    ...
    public static void main(String[] args) {
        ...
        updatedExhcangeRates(); //gets updated exchange rates from API
    ...
    //new error steming from this is: Could not find or load main class
    //new code from AI for the API KEY
    public static void updatedExhcangeRates() {
        try {
            URL url = new URL(API_URL);
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
            connection.setRequestMethod("GET");
